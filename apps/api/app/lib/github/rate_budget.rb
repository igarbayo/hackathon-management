# RNF-GH-002: GitHub API quota of each installation, shared by every job.
# Client records here the last thing GitHub said (x-ratelimit-*) and, once
# below the 20% reserve, stops calling until the reset without spending
...
module Github
  module RateBudget
    ...
    # Until when calls are not allowed, or nil if the quota is above the reserve.
