...
module Features
  class Update
    def self.call(feature:, attrs:)
      ...
      emit_status_event(feature, previous_status) if status_changing
      emit_assignee_event(feature) if assignees_changing

      feature
    end

    def self.emit_status_event(feature, previous_status)
    ...
    def self.emit_assignee_event(feature)
      ActivityEvent.create!(
        team_id: feature.team_id,
        source: "system",
