...
RSpec.describe "Teams", type: :request do
  describe "POST /api/v1/teams" do
    ...
    it "without starts_at, the hackathon starts now (04-pantallas.md#onboarding)" do
    ...
    it "keeps the given starts_at" do
      sign_in_as(create(:user))
  ...
  describe "PATCH /api/v1/teams/:id" do
    ...
    it "the owner can change the start and end, and the repos are imported again (RF-TEAM-015)" do
      membership = create(:membership, :owner)
