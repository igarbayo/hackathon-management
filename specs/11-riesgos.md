...
| R4 | **Adopción en caliente.** Nadie configura algo que tarde más de 2 minutos. | A | A | Onboarding de 3 pantallas más un perfil que solo sale una vez (ADR-0019), pasos opcionales, pegar el repo, device flow sin copiar tokens y métrica p50 < 2 min. | Abierto |
