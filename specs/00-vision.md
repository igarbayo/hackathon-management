...
4. **La IA propone y el humano decide.** La IA nunca cambia estados, asignaciones ni atribuciones confirmadas.
...
Incluye: autenticación, equipos con código de unión, objetivos, features en kanban, pros y contras con votos, milestones y timeline, GitHub App con feed de actividad, atribución en tres capas, análisis con Gemini, CLI de hooks para Claude Code y (si da tiempo) el servidor MCP.

## No-objetivos (por ahora)

- Leer conversaciones de claude.ai: no hay una API pública para ello.
...
| **Token de miembro** | Credencial por persona y equipo que usan el CLI y el MCP para enviar eventos. |
